...
const pages: Page[] = [
  ...
  { path: '/courses', name: 'courses', authenticated: true },
  { path: '/enrollments', name: 'enrollments', authenticated: true, role: 'ROLE_STUDENT' },
  { path: '/notifications', name: 'notifications', authenticated: true, role: 'ROLE_STUDENT' }
];
